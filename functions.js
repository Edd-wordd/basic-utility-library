// Stand in line
function standInLine(num1) {
   var line = [1, 2, 3, 4, 5, 6]; //people in line
   line.push(num1); //user inputs an array and adds to the end of the line
   ...
   // shift adds the value to the end of the array
   return upNext + " at the end of the line " + line;
}
